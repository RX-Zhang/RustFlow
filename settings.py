...
test_constraints_prompt = [
    "Avoid using Traits in the translated Rust code whenever possible.",
    "Minimize the use of custom Generics.",
    "Use standalone functions rather than struct methods.",
    "Provide only the translated Rust function, without additional explanations or a main function.",
]
...
class Options:
    ...
    few_shot: bool = True # True  or False

    # Parameters related to the thought chain
    cot: bool = True # True or False
