...
pub fn opl_emu_bitfield(value: u32, start: i32, length: i32) -> u32 {
    let mask = (1u32.wrapping_shl(length as u32 % 32)).wrapping_sub(1);
...
pub fn opl_emu_registers_op_decay_rate(regs: &OplEmuRegisters, opoffs: usize) -> u32 {
    opl_emu_registers_byte(regs, 0x60, 0, 4, opoffs % OPL_EMU_REGISTERS_REGISTERS)
}
