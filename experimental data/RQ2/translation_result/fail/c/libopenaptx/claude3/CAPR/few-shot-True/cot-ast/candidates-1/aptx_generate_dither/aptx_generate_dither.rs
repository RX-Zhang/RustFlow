...
struct AptxPrediction {
    ...
    d_weight: [i32; 24],
    pos: i32,
    reconstructed_differences: [i32; 32], // Changed from 48 to 32 to satisfy Default trait
...
fn aptx_update_codeword_history(channel: &mut AptxChannel) {
    ...
    channel.codeword_history = ((cw as i32) << 8).wrapping_add(
...
fn aptx_generate_dither(channel: &mut AptxChannel) {
    ...
    let m = (Wrapping(5184443_i64) * Wrapping((channel.codeword_history >> 7) as i64)).0;
