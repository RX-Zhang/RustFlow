...
fn rshift64(value: i64, shift: u32) -> i64 {
    ...
    let mask = (1_i64 << (shift + 1)).wrapping_sub(1);
...
fn rshift32(value: i32, shift: u32) -> i32 {
    ...
    let mask = (1_i32 << (shift + 1)).wrapping_sub(1);
...
fn aptx_invert_quantization(invert_quantize: &mut AptxInvertQuantize, quantized_sample: i32, dither: i32, tables: &AptxTables) {
    ...
    qr = rshift64_clip24(
        (qr as i64).wrapping_mul(1_i64 << 32).wrapping_add((dither as i64).wrapping_mul(tables.invert_quantize_dither_factors[idx] as i64)),
        32
    );
