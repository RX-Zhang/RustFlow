...
static APTX_QMF_INNER_COEFFS: [[i32; FILTER_TAPS]; NB_FILTERS] = [
    [
        1033, -584, -13592, 61697, -171156, 381799, -828088, 3962579, 985888,
        -226954, 39048, 11990, -14203, 4966, 973, -1268,
    ],
    [
        -1268, 973, 4966, -14203, 11990, 39048, -226954, 985888, 3962579,
        -828088, 381799, -171156, 61697, -13592, -584, 1033,
    ],
];

static APTX_QMF_OUTER_COEFFS: [[i32; FILTER_TAPS]; NB_FILTERS] = [
    [
        730, -413, -9611, 43626, -121026, 269973, -585547, 2801966, 697128,
        -160481, 27611, 8478, -10043, 3511, 688, -897,
    ],
    [
        -897, 688, 3511, -10043, 8478, 27611, -160481, 697128, 2801966,
        -585547, 269973, -121026, 43626, -9611, -413, 730,
    ],
];
...
fn aptx_qmf_tree_synthesis(
    ...
    for i in 0..2 {
        aptx_qmf_polyphase_synthesis(
            ...
            &mut intermediate_samples[2 * i..2 * i + 2], // Corrected slice
        );
    }
    ...
    for i in 0..2 {
        aptx_qmf_polyphase_synthesis(
            ...
            &mut samples[2 * i..2 * i + 2], // Corrected slice
        );
    }
}
