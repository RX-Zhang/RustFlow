...
fn rshift64(value: i64, shift: u32) -> i64 {
    ...
    let mask: i64 = ((1i64 << (shift + 1)) as i64).wrapping_sub(1);
    ((value).wrapping_add(rounding) >> (shift % 64)) - if (value & mask) == rounding { 1 } else { 0 }
}
...
fn aptx_qmf_convolution(signal: &aptx_filter_signal, coeffs: &[i32; FILTER_TAPS], shift: u32) -> i32 {
...
fn aptx_qmf_filter_signal_push(signal: &mut aptx_filter_signal, sample: i32) {
