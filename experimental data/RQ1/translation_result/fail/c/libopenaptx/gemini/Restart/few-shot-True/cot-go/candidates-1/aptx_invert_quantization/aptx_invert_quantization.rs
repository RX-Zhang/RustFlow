...
const INT32_MIN: i32 = 0x80000000u32 as i32;
const INT64_MAX: i64 = 0x7FFFFFFFFFFFFFFF;
const INT64_MIN: i64 = 0x8000000000000000u64 as i64;
...
fn rshift64(value: i64, shift: u32) -> i64 {
    ...
    ((value + rounding as i64) >> shift as isize) - ((value & mask as i64) == rounding as i64) as i64
}
...
fn aptx_invert_quantization(invert_quantize: &mut Box<AptxInvertQuantize>, quantized_sample: i32, dither: i32, tables: &AptxTables) {
    let mut qr: i32;
    let mut idx: i32;
    let mut shift: i32;
    ...
    qr = rshift64_clip24(((qr as i64).wrapping_mul((1 << 30) as i64) + (dither as i64).wrapping_mul(tables.invert_quantize_dither_factors[idx as usize] as i64)), 30); // Changed 32 to 30 to avoid overflow.
