...
fn opl_emu_bitfield(value: u32, start: i32, length: i32) -> u32 {
    ...
    (value.wrapping_shr(start % 32)) & ((1u32.wrapping_shl(length)) - 1)
}

fn opl_emu_registers_byte(regs: &OplEmuRegisters, offset: u32, start: u32, count: u32, extra_offset: u32) -> u32 {
    let offset = (offset + extra_offset) as usize;
    opl_emu_bitfield(regs.m_regdata[offset] as u32, start as i32, count as i32)
}
