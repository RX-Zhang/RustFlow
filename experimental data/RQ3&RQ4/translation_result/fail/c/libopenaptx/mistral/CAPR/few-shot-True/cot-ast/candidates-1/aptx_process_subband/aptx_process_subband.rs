...
fn aptx_reconstructed_differences_update(
    ...
    &mut prediction.reconstructed_differences[p + order as usize]
}
...
fn aptx_prediction_filtering(
    ...
    let srd0 = (DIFFSIGN(reconstructed_difference, 0) as i32) * (1 << 23);
    for i in 0..order {
        let srd = (reconstructed_differences[-i as usize - 1] >> 31) | 1;
