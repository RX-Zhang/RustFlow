...
fn opl_emu_registers_byte(regs: &OplEmuRegisters, offset: u32, start: u32, count: u32, extra_offset: u32) -> u32 {
    let offset = Wrapping(offset) + Wrapping(extra_offset);
    opl_emu_bitfield(regs.m_regdata[offset.0 as usize] as u32, start as i32, count as i32)
}
...
fn opl_emu_registers_ch_output_0(regs: &OplEmuRegisters, choffs: u32) -> u32 {
