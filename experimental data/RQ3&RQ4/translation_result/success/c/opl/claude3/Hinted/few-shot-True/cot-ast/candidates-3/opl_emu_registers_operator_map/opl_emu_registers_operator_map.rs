...
fn opl_emu_bitfield(value: u32, start: u32, length: u32) -> u32 {
    (value.wrapping_shr(start)) & ((1u32.wrapping_shl(length)).wrapping_sub(1))
}
...
fn opl_emu_registers_operator_list(o1: u8, o2: u8, o3: u8, o4: u8) -> u32 {
    (o1 as u32) | ((o2 as u32).wrapping_shl(8)) | ((o3 as u32).wrapping_shl(16)) | ((o4 as u32).wrapping_shl(24))
}
